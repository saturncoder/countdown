 ...
 */
class ItemAppWidget1to1 : AppWidgetProvider() {

    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        Log.e("小工具11","onUpdate")
        Log.e("小工具11","個數:${appWidgetIds.size}")
        //Toast.makeText(context, "Widget has been updated! ", Toast.LENGTH_SHORT).show()
        // There may be multiple widgets active, so update all of them
        for (appWidgetId in appWidgetIds) {
            ItemAppWidget1to1.updateAppWidget(context, appWidgetManager, appWidgetId)
        }
    }
    ...
    override fun onDeleted(context: Context, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {//被刪掉的，一次只刪一個，所以array size=1
            ...
            Log.e("小工具11","ondelete cancel:appWidgetId $appWidgetId")
        }
    }
    ...
    companion object {
        ...
        internal fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager,
            ...
            Log.e("widget11","update function called")
            ...
            val views = RemoteViews(context.packageName, R.layout.item_app_widget11)
            views.setTextViewText(R.id.appwidget_title11, title)
            views.setTextViewText(R.id.appwidget_days11,days.toString())
            ...
            val pending = PendingIntent.getActivity(
                    context, 0, intent, 0)
            views.setOnClickPendingIntent(R.id.widgetLL11, pending)
